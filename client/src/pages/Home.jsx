  ...
  return (
    <div className="flex flex-col min-h-screen">
      <div className="relative bg-black text-white rounded-3xl overflow-hidden mb-12 shadow-2xl">
        <div className="absolute inset-0 opacity-40 bg-[url('https://images.unsplash.com/photo-145974941115-04bf5292ceea?q=80&w=3000&auto=format&fit=crop')] bg-cover bg-center"></div>
        ...
        <div className="relative p-10 md:p-20 text-center flex flex-col items-center z-10">
          ...
          <p className="text-gray-300 text-lg md:text-xl mb-10 max-w-2xl mx-auto font-light leading-relaxed">
            ...
            hands-on workshops happening directly in your area. Secure your seat
            today
          </p>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 px-4">
            <div className="bg-white p-8 rounded-2xl shadow-sm border border-gray-100 flex flex-col items-center text-center hover:-translate-y-1 transition duration-300">
              <div className="w-16 h-16 bg-gray-900 text-white rounded-2xl flex items-center justify-center mb-6 text-2xl shadow-md shadow-gray-200/50">
                <FaRegClock />
              </div>
              ...
              <p className="text-gray-500 text-sm leading-relaxed">
                ...
                infrastructure build for speed.
              </p>
            </div>
                ...
                >
                  ...
                  <div className="p-6 flex-grow flex flex-col">
                    ...
                    <div className="mt-auto">
                      ...
                      <Link className="block w-full text-center bg-gray-100 hover:bg-gray-200 text-gray-900 font-semibold py-2 rounded-lg transition">
                        View Details
                      </Link>
                    </div>
                  </div>
